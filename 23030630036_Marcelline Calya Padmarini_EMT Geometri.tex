...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-004.png}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-005.png}
\begin{eulerprompt}
>plotSegment(K,L,"m");
>plotSegment(L,M,"n");
>plotSegment(M,K,"l"):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-006.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-008-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-010-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-016-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-020.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-022.png}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-032.png}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
kita dapat melihat rumus heron
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-036.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-040-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-041.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
dimana (xm, ym) adalah psuat, dan u dan v adalah setengah sumbu.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\left[ 2\,H\left(a , b , d-b-a\right)\,\left(\frac{d}{d\,a}\,H  \left(a , b , d-b-a\right)\right)=0 , 2\,H\left(a , b , d-b-a\right)  \,\left(\frac{d}{d\,b}\,H\left(a , b , d-b-a\right)\right)=0   \right] 
\]
\end{eulerformula}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-048-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-049.png}
\begin{eulercomment}
Plot segmen
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-050.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Mari kita dapatkan rumus untuk jari-jari lingkaran
\end{eulercomment}
\begin{eulerprompt}
>plotPoint(U()); ...
>plotCircle(circleWithCenter(mxmeval("U"),mxmeval("distance(U,C)"))):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-052.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
untuk radiusnya. Kita dapat memeriksa apa ini benar dengan Maxima.
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-055.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-059-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-065.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-072.png}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-076.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-079-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-082-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-083.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-092-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-098.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-101-large.png}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-102-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-109-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-118-large.png}
...
\end{eulerformula}
\begin{eulercomment}
Aturan ini berlaku untuk setiap tiga sudut yang menambah ke 180°.
...
\end{eulerformula}
\begin{eulercomment}
karena penyebaran sudut negatif sama, aturan triple spread juga
berlaku, jika
...
\end{eulerformula}
\begin{eulercomment}
Sebagai contoh, kita dapat menghitung penyebaran sudut 60°. Ini 3/4.
...
\end{eulerformula}
\begin{eulercomment}
Sebaran 90° dengan jelas 1. Jika dua sudut dijumlahkan menjadi 90°,
...
\]
\end{eulerformula}
\eulerimg{0}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-126-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-128.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-130-large.png}
\eulerimg{1}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-131-large.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Kita dapat mencetak sudut dalam Euler, setelah mentransfer penyebaran
ke radian.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-133.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
berlaku dalam segitiga apapun. Kuadratkan itu diterjemahkan ke dalam
...
\end{eulerformula}
\begin{eulercomment}
dimana a, b, c menunjukan kuadran.
...
\end{eulerformula}
\begin{eulercomment}
Mari kita periksa rumus ini untuk nilai-nilai Egyptian
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-138.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
kita bisa membuat fungsi euler.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Sebenarnya spreadnya adalah b/(4r) dan kita melihat bahswa sudut chord
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-144.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-145.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-146.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-147.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-148.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-149.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-150.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-151.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-153.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-154.png}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-155.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-159.png}
...
>povend();
\end{eulerprompt}
\eulerimg{22}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-160.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{22}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-161.png}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-162.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-163.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-164.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-165.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-166.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-167.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-168.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-169.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-170.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{34}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-171.png}
\begin{eulerprompt}
>reset; plot3d("d2",xmin=-2,xmax=2,ymin=-4,ymax=4):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-172.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-2,xmax=2):
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-173.png}
\begin{eulerprompt}
>P= [-1,0];
>Q= [1,0];
>distance(P,Q)
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-174.png}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/23030630036_Marcelline Calya Padmarini_EMT Geometri-175.png}
\end{eulernotebook}
\end{document}

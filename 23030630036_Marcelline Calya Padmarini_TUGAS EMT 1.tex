...
dicontohkan di atas.
\end{eulercomment}
\eulerheading{LATIHAN EMT MARCELLINE}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
String dapat digabungkan dengan \textbar{} atau + serta dapat juga berfungsi
...
\begin{eulercomment}
1. Tentukan nilai x1 dan x2 dari 3x\textasciicircum{}2-5x=-1!

Jawab:\\
Apabila penyelesaian yang dilakukan menggunakan LaTeX, maka harus
diawali dengan tanda "\textdollar{}\&"
\end{eulercomment}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
\left[ x=\frac{5-\sqrt{13}}{6} , x=\frac{\sqrt{13}+5}{6} \right] 
\]
\end{eulerformula}
\begin{eulercomment}
Sedangkan, apabila penyelesaian dilakukan dengan perhitungan
...
2. Tentukan nilai x1 dan x2 dari 2(x\textasciicircum{}2)+3x-5 dan gambarlah grafiknya!
...
\eulersubheading{}
\begin{eulercomment}
3. Diberikan f(x)=x\textasciicircum{}3-6x\textasciicircum{}2-2x+40, hitung nilai f(-5) dan f(4)!
